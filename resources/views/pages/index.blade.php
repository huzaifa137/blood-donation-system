...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1 id="head-one">Welcome to Medilab</h1>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              <h3 class="special">Why Choose Medilab?</h3>
              <p>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Donate blood right now and save 2 lives</h2>
          <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint
            consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit
            in iste officiis commodi quidem hic quas.</p>
        </div>

        <form action="/pages/appointment" method="POST" role="form" class="php-email-form">
          @csrf
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
              <select name="doctor" id="doctor" class="form-select">
                <option value="">Times Donated</option>
          ...
          <div class="text-center"><button type="submit">Register for an Appointment</button>
          <a href="/pages/appointment" class="btn btn-info ms-3 p-2 rounded-pill text-light"> Donate now</a>
    ...
    <section id="doctors" class="doctors">
      <div class="container">
        ...
        <div class="section-title modiy">
          <h2 id="modify">Doctors</h2>
          <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint
            consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit
            in iste officiis commodi quidem hic quas.</p>
        </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              <div class="row">
                ...
                @error('name')<span color="red">{{$message}}</span> @enderror
  ...
  <footer id="footer">
    ...
    <div class="footer-top">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-7 col-md-4 footer-newsletter ">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        ...
        <div class="credits">
          Designed by <a href="#">TechSateTechnologies</a>
        </div>
      </div>
